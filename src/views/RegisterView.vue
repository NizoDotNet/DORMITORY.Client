      ...
      <div class="row">
        <div class="col">
          <div class="mb1">
            ...
            <input id="email" v-model="registerData.email" type="email" class="form-control form-control-lg" placeholder="name@example.com">
            <span v-if="validations.email" class="text-danger">{{ validations.email[0] }}</span>
          </div>
          <div class="mb-1">
            <label class="form-label">Şifrə</label>
            <input v-model="registerData.password" type="password" class="form-control form-control-lg">
            <span v-if="validations.password" class="text-danger">{{ validations.password[0] }}</span>
          </div>
          <div class="mb-1">
            <label class="form-label">FİN</label>
            <input v-model="registerData.fin" class="form-control form-control-lg" placeholder="7ABC21O">
            <span v-if="validations.fin" class="text-danger">{{ validations.fin[0] }}</span>
          </div>
          <div class="mb-1">
            <label class="form-label">Ş/V seriya nömrəsi</label>
            <input v-model="registerData.passportNo" class="form-control form-control-lg" placeholder="AA3456789">
            <span v-if="validations.passportNo" class="text-danger">{{ validations.passportNo[0] }}</span>
          </div>
          <div class="mb-1">
            <label class="form-label">Ad</label>
            <input v-model="registerData.firstname" class="form-control form-control-lg" placeholder="Nizami">
          ...
          <div class="mb-1">
            ...
            <input v-model="registerData.secondname" class="form-control form-control-lg"  placeholder="Mamedov">
          ...
          <div class="mb-1">
            ...
            <input v-model="registerData.phoneNumber" class="form-control form-control-lg" placeholder="+994XX-XXX-XXXX">
          </div>
        </div>
        <div class="col">
          <div class="mb-1">
            <label class="form-label">Otaq</label>
            <input v-model="registerData.dormitoryRoom" class="form-control form-control-lg" placeholder="">
          </div>
          <div class="mb-1">
          ...
          <div class="mb-1">
            ...
            <input class="form-control form-control-lg" v-model="registerData.fatherName"/>
          ...
          <div class="mb-1">
            ...
            <input v-model="registerData.code" class="form-control form-control-lg" placeholder="IKT2251">
