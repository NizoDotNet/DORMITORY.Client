...
onMounted(async () => {
  try {
    ...
    userData.value = {...user}
    userData.value.dormitoryRoom = user.room
...
const updateUser = async () => {
  ...
  try {
    const userUpdate = await axios.put(`/api/users/${userData.value.id}`, userData.value)
...
<template>
  <div class="d-flex align-items-center justify-content-center" style="margin: 10px">
    <div class="form p-2 d-inline-flex justify-content-center align-items-center" style="margin-bottom: 100px">
      <form @submit.prevent="updateUser">
        <div class="row">
          <div class="col" style="width: 357.484px;">
            <h4 class="mt-3 mb-3 text-danger text-center">İxtisas və bloku yenidən seçin!</h4>
            <div class="m-3">
              <label for="email" class="form-label">Email</label>
              <input id="email" v-model="userData.email" type="email" class="form-control" placeholder="name@example.com">
            ...
            <div class="m-3">
              ...
              <input v-model="userData.fin" class="form-control" placeholder="7ABC21O">
              <span v-if="validations.fin" class="text-danger">{{ validations.fin[0] }}</span>
            </div>
            <div class="m-3">
              <label class="form-label">Ş/V seriya nömrəsi</label>
              <input v-model="userData.passportNo" class="form-control" placeholder="AA3456789">
              <span v-if="validations.passportNo" class="text-danger">{{ validations.passportNo[0] }}</span>
            </div>
            <div class="m-3">
              <label class="form-label">Ad</label>
              <input v-model="userData.firstname" class="form-control" placeholder="Nizami">
            ...
            <div class="m-3">
              ...
              <input v-model="userData.secondname" class="form-control" placeholder="Mamedov">
            ...
            <div class="m-3">
              ...
              <input v-model="userData.phoneNumber" class="form-control" placeholder="+994XX-XXX-XXXX">
            </div>
          </div>
          <div class="col" style="width: 357.484px;">
            <div class="m-3">
              <label class="form-label">Otaq</label>
              <input v-model="userData.dormitoryRoom" class="form-control" placeholder="">
            </div>
            <div class="m-3">
              <label class="form-label" >Blok</label>
              <select v-model="userData.blockId" class="form-select">
            ...
            <div class="m-3">
              ...
              <select v-model="userData.course" name="" id="" class="form-select">
            ...
            <div class="m-3">
              ...
              <input v-model="userData.code" class="form-control " placeholder="IKT2251">
