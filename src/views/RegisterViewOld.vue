    ...
    >
      <form @submit.prevent="register">
        <div class="row">
          ...
          <div class="col">
            <div class="mb-3">
              ...
              <input
                v-model="registerData.dormitoryRoom"
                class="form-control"
                placeholder=""
              />
            </div>
            <div class="mb-3">
              ...
              <input
                v-model="registerData.dormitoryBlock"
                class="form-control"
                placeholder=""
              />
            </div>
            ...
            <div class="mb-3">
              ...
              <select
                ...
                class="form-select"
              >
                <option v-for="spec in specializations" :value="spec.id">
                  {{ spec.name }}
                </option>
              </select>
            </div>
        ...
        <div class="d-flex justify-content-end mb-3">
          <button class="btn btn-primary">Davam et</button>
        </div>
      </form>
    </div>
  </div>
