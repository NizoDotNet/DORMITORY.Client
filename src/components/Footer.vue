      ...
      >
        <div class="col-md-4 d-flex align-items-center">
          ...
          <span class="mb-3 mb-md-0 text-white"
            >© {{ new Date().getFullYear() }} ADAU, Inc</span
          >
        </div>
        ...
        <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
          <li class="ms-3">
            <a
              ...
              href="https://www.instagram.com/adaueduaz/"
            >
              <img
          ...
          <li class="ms-3">
            <a
              class="text-body-secondary"
              href="https://www.facebook.com/ADAUASAU"
            >
              <img
          ...
          <li class="ms-3">
            <a class="text-body-secondary" href="https://adau.edu.az/">
              <img
